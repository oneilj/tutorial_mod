package com.jennyo.tutorial.world.gen;

import com.google.common.eventbus.Subscribe;
import com.jennyo.tutorial.Tutorial;
import com.jennyo.tutorial.util.RegistryHandler;
    ...
    public static void generateOres(FMLLoadCompleteEvent event){
        for(Biome biome : ForgeRegistries.BIOMES) {
            ...
            if (biome.getCategory() == Biome.Category.NETHER) {
                ...
                // Over world Biomes
                genOre(biome, 15, 8, 5, 30, OreFeatureConfig.FillerBlockType.NATURAL_STONE,
                        RegistryHandler.SAPPHIRE_ORE.get().getDefaultState(), 5);
            }
        }
    }
